    ...
    <Box bg="gray.900" minH="100vh" pb={10}>
      ...
      <Container maxW="900px" mt={-10} position="relative" zIndex={2}>
        <Box bg="gray.800" p={8} borderRadius="2xl" shadow="xl">
            ...
            <Text fontSize="lg" color="gray.400" lineHeight="tall" mb={10}>
                        ...
                        <TabPanel>
                            {sent ? (
                                <Box textAlign="center" py={6}>
                                    ...
                                    <Text fontSize="xl" fontWeight="bold" color="green.400">Message envoyé !</Text>
                                ...
                                <form onSubmit={handleSendLead}>
                                    <VStack spacing={4}>
                                        <Flex w="full" gap={4} direction={{ base: 'column', md: 'row' }}>
                                            <FormControl isRequired><FormLabel>Prénom</FormLabel><Input bg="gray.600" value={firstName} onChange={(e) => setFirstName(e.target.value)} /></FormControl>
                                            <FormControl isRequired><FormLabel>Nom</FormLabel><Input bg="gray.600" value={lastName} onChange={(e) => setLastName(e.target.value)} /></FormControl>
                                        </Flex>
                                        <Flex w="full" gap={4} direction={{ base: 'column', md: 'row' }}>
                                        ...
                                        <FormControl>
                                            ...
                                            <Textarea bg="gray.600" placeholder="Je souhaiterais visiter ce bien..." value={message} onChange={(e) => setMessage(e.target.value)} />
                                        </FormControl>
